...
namespace SistemasVentas.VISTA.DetalleIngVistas
{
    public partial class DetalleIngEditarVista : Form
    {
        ...
        private void DetalleIngEditarVista_Load(object sender, EventArgs e)
        {
            ...
            textBox5.Text = p.IdIngreso.ToString();
            textBox6.Text = p.IdProducto.ToString();
            dateTimePicker1.Value = p.FechaVenc;
            textBox1.Text = p.Cantidad.ToString();
            textBox2.Text = p.PrecioCosto.ToString();
            textBox3.Text = p.PrecioVenta.ToString();
            textBox4.Text = p.SubTotal.ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            p.PrecioCosto = Convert.ToDecimal(textBox2.Text);
            p.PrecioVenta = Convert.ToDecimal(textBox3.Text);
            p.SubTotal = Convert.ToDecimal(textBox4.Text);
